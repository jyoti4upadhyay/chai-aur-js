...
accountCity="Jaipur"//variable but not use of let and var also consider it as variable bc js is a safe lang
let accountState;
...
console.table([accountId,accountEmail,accountPassword,accountCity ,accountState]) // print output in tabular form
